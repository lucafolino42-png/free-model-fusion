...
export const config = {
  ...
  expertMaxTokens: parseInt(process.env.FUSION_EXPERT_MAX_TOKENS || '2000', 10),
  ...
  continuationMaxTokens: parseInt(process.env.FUSION_CONTINUATION_MAX_TOKENS || '22500', 10),
